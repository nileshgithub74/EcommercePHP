    ...
    <div class="container mx-auto py-4 px-6">
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          <a href="#" class="text-2xl font-bold text-transparent bg-clip-text bg-gradient-animate">Ecommerce</a>
          ...
          <div class="relative group">
            ...
            <ul id="profileDropdown"
              ...
              <?php if (isset($_SESSION["email"]) && !empty($_SESSION['email'])) { ?>
                <li><a href="/merchant-index.php"
                    class="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-t-lg">Profile</a>
                </li>
                <li><a href="../logout.php"
                    class="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded-b-lg">Logout</a>
                </li>
              <?php } else { ?>
