...
<div class="container mx-auto p-6">
  <h3 class="text-2xl font-bold text-center">Merchant Registration</h3>
  <hr class="my-4">
  <form method="POST" action="merchant-engine.php" enctype="multipart/form-data"
    ...
    <div class="mb-4">
      ...
      <input type="text" class="mt-1 block w-full border rounded-lg p-2" id="phone_no" placeholder="Enter Phone No."
    ...
    <hr class="my-4">
    <button id="submit" name="merchant_register"
      class="w-full bg-blue-500 text-white py-2 rounded-lg hover:bg-blue-600 transition"
      onclick="return Validate()">Register</button>

    <div class="mt-4 text-right">
      <label class="text-gray-600">Register as a <a href="customer-register.php"
          class="text-blue-500 underline">Customer</a>?</label>
    </div>
  </form>
</div>
